...
<div class="w-full h-auto py-4 md:py-0 space-y-2 md:space-y-0 md:h-20 flex flex-col md:flex-row justify-between md:items-center px-6 md:px-16 border-b">
    ...
    <!-- Breadcrumb -->
    <div class="flex flex-row justify-end space-x-8 w-auto h-auto mr-6 md:mr-0">
        <span class="font-bold text-sm text-gray-600 py-2">Home</span>
        <span class="text-gray-600 py-2.5">
        ...
        <span class="font-bold text-sm text-gray-600 py-2">Upload Item</span>
    </div>
</div>